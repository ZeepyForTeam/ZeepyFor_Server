...
public class BuildingController {
    ...
    public ResponseEntity<Page<BuildingResponseDto>> getBuildings(
            ...
            @RequestParam(value = "eqSoundInsulation", required = false) MultiChoiceReview soundInsulation,
            @RequestParam(value = "eqPest", required = false) MultiChoiceReview pest,
            @RequestParam(value = "eqLightning", required = false) MultiChoiceReview lightning,
            @RequestParam(value = "eqWaterPressure", required = false) MultiChoiceReview waterPressure,
            @RequestParam(value = "eqCommunicationTendency", required = false) CommuncationTendency communcationTendency,
