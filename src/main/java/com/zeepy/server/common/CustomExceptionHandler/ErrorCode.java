...
public enum ErrorCode {
    ...
    NOT_FOUND_ELEMENT(400, "찾고자하는 값이 업습니다."),
    NOT_FOUND_COMMUNITY(400, "찾고자하는 커뮤니티를 찾을수 없습니다."),
    NOT_FOUND_PARTICIPATION(400, "찾고자하는 참여자 목록을 찾을수 없습니다."),
    NOT_FOUND_USER(400, "찾고자하나는 사용자를 찾을수 없습니다"),
